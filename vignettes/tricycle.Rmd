...
library(ggplot2)
library(scattermore)
qplot(x = reducedDim(neurosphere_example)[, 1],y = reducedDim(neurosphere_example)[, 2]) +
...
ggplot(data = data.frame(theta = neurosphere_example$CCTime, top2a = assay(neurosphere_example, 'logcounts')[top2a.idx, ])) +
  ...
  labs(x = "Cell cycle time \u03b8", y = "log2(Top2a)", title = paste0("Expression of Top2a along \u03b8 (n=", ncol(neurosphere_example), ")")) +
  theme_bw(base_size = 14)
```
